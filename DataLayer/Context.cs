...
namespace DataLayer
{
    public class Context : DbContext
    {
        ...
        public void Reset()
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Server=sqlutb2-db.hb.se,56077;Database=suht2410;User Id=suht2410;Password=VOB279;TrustServerCertificate=True;"))
